...
```bash
git clone https://github.com/inveks/customize-windows-vagrant
...
Then, [install and start the WinDHCP DHCP service](https://github.com/inveks/WinDHCP#service-installation).
